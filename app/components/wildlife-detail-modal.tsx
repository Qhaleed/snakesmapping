...
export default function WildlifeDetailModal({ selectedWildlife, closeModal, visible }: WildlifeDetailModalProps) {
  ...
  return (
    <div className={`fixed left-0 top-0 z-[500] transition-opacity duration-1000  ${visible ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <p className="text-gray-700 mb-2">{selectedWildlife.description}</p>
        ...
        <div className="flex gap-2 mb-4">
          <button className="group flex-1 bg-white text-black py-2 rounded-lg flex items-center justify-center gap-2 hover:cursor-pointer ">
